                    ...
                    <div class="row height-margin20"></div>
                     <div class="row left-sidebar-contents">
                        ...
                        <div class="row company-logo">
                            <img src="<?php if(!empty($img->image_name)){echo site_url().'companylogo/'.$img->image_name;} else{ echo site_url('themes/images/company/websphere.png');} ?>" alt="" title="">
  ...
  <div class="modal-dialog" role="document">
     ...
     <div class="modal-body">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="<?php if(isset($img->image_name)){ echo 'update_image';}else{echo 'add_image';}?>" class="btn btn-primary">Save</button>
      </div>
    </div>
          </form>
  </div>
                           ...
                           <?php if(!empty($cmpInfo->cmp_id)){?>
                             <a href="<?php echo site_url('company/updatecmp').'/'.$cmpInfo->cmp_id; ?>" class="btn btn-success">Update Information</a>
                            
                           <?php }else {?>
                             <a href="<?php echo site_url('company/cmpinformation'); ?>" class="btn btn-addition">Add Company Information</a>
                           <?php }?>
                        </div>
                    </div>  
                </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row listing-box">
                            <div class="row title-outer">
                                 ...
                                 <div class="col-md-8">
                                <h3 class="post-title"><?php if(!empty($cmpInfo->cmp_name)){echo $cmpInfo->cmp_name;};?></h3>
                        ...
                        <div class="col-md-3 date-area">
                            ...
                            <p class="post-detail">
                            <?php if(!empty($cmpInfo->cmp_detail_summary)){ ?>
                             ...
                             <div class="col-md-12 description">
                               ...
                               <h4>Recent Jobs Posted</h4>
                                 ...
                                 <div class="row" style="text-align: right;margin: 0px;">
                                     <a href="<?php echo site_url('company/addNewJob'); ?>" class="btn btn-success">Post new Job</a>
                                 </div>
                                 <div class="height-margin10"></div>
                                        ...
                                        <th>Action</th>
                                         ...
                                         <tbody>
                                             ...
                                             <td><?php echo $job->job_title; ?></td>
                                              ...
                                              <td><a href="<?php echo site_url('company/repost').'/'.$job->job_id; ?>">Repost</a> | <a href="<?php echo site_url('company/viewdetail').'/'.$job->job_id; ?>">View Detail</a> | <a href="<?php echo site_url('company/deletejob').'/'.$job->job_id; ?>">Delete</a></td>
                                        </tr>
                                             <?php } } else{?>
                                        <tr>
                                            <td colspan="4">
