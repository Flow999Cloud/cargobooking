                ...
                <div class="col-md-9">
                    <div class="container-fluid">
                       <?php echo validation_errors(); ?>
                        ...
                        <div class="row height-margin30"></div>
                        <form name="login-from" class="field-form" action="<?php echo site_url('company/save_profile'); ?>" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-5">
                                    <label>Company Name*</label>
                                    <input type="text" class="form-control" value="<?php echo set_value('cname'); ?>" name="cname">
                                </div>
                           </div>
                            <div class="row">
                               <div class="col-md-5">
 ...
 <option value="Other">Other</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                 ...
                                 <textarea name="detail" class="form-control" required=""><?php echo set_value('detail'); ?></textarea>
                                </div>
                            ...
                            <div class="row">
                                <input type="submit" name="btnsave" value="Save" class="btn btn-default form-submit">
                            </div>
                        </form>  
