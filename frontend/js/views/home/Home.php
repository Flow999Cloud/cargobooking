           ...
           <div class="col-md-9">
               <div class="row height-margin30"></div>
                <div class="row heading-wrapper">
                    ...
                    <div class="col-md-12">
                          <h1 class="website-title">CareersPak – Pakistan’s Largest Jobs Website</h1>
                          <br>
                <p class="title-h3" style="font-weight: bold;">Find your best job today</p>
                
            </div>
               </div> 
               <div class="row">
                   <div class="col-md-9 search-home" style="margin-left: 1.5%;">
                       <div class="row search-form-title">
                       <p>Search and find jobs now</p>
                   </div>
                   <div class="row">
                       <div class="col-md-1"></div>
                       <div class="col-md-9">
                           <form name="search-form-home" class="search-form-home" action="<?php echo site_url('jobs/search'); ?>" method="post" enctype="multipart/form-data">
                           <div class="row">
                           <div class="form-group">
                          <label for="exampleInputEmail1">Key Word</label>
                          <input type="text" class="form-control" name="job_title" id="keyword" placeholder="Enter search key word....">
                        </div>
                        </div>
                           <div class="row">
...
<option value="Warehousing">Warehousing</option>                        
 <option value="Other">Other</option>
               ...
               <br>
               <p class="intro-text">CareersPak is Pakistan’s largest and most popular jobs website, where you can start finding the best job to bright your future. .</p>
                <p class="intro-text">If you are an employer, create your company profile and find experts to grow your business.</p>
           </div>
        </div>   
    </div>
    <div class="container-fluid contents-wrappper">
        <div class="row height-margin20"></div>
        <div class="row sections-wrapper">
            <div class="col-md-4 box-outer" >
                <div class="row content-boxes">
                    <h3 class="box-title">Free Company Membership</h3>
                    <p class="box-content">
                         Free membership and job posting for companies. 
                         Now, you do not need to spend extra money for hiring the potential candidate.
                    </p>
                </div>  
            </div>
            <div class="col-md-4 box-outer">
               <div class="row content-boxes">
                   <h3 class="box-title">Easy Registration</h3> 
                    <p class="box-content">
                    A simple and easy way to get a job seeker account.
            ...
            <div class="col-md-4 box-outer">
                <div class="row content-boxes">
                    <h3 class="box-title">Profile Verification</h3>
                     <p class="box-content">
                     The profile of both employer and job seeker is verified via 
                     Email before start using.
                    </p>
                </div> 
            </div>
        </div>
    ...
    <div class="container-fluid section-featured">
       
     <div class="row featured-wrapper">
            <div class="col-md-8 featured-outer">
                <div class="row featured-list">
                    
                    <div class="row featured-title-row">
                        <h2 class="featured-title">Latest Jobs</h2>
                    </div>
                    <?php if(count($jobdata)){ ?>
                    <?php  foreach($jobdata as $job){?>
                    <div class="row featured-cnt-row">
                        <div class="col-md-9">
                            <a href="<?php echo site_url('jobs/jobDetail').'/'.$job->job_title; ?>"><h3 class="post-title"><?php echo $job->job_title; ?></h3></a>
                        </div>
                        <div class="col-md-3 date-area">
                            <p class="post-date">Posted: <?php echo $job->job_post_date; ?></p>
                        </div>
         ...
         <div class="col-md-4 right-bar">
             <div class="row featured-list">
                 <div class="row featured-title-row">
                     <h2 class="featured-title">Featured employers</h2>
                     <div class="col-md-6 employee">
                         <img src="<?php echo site_url('themes/images/microsoft.png'); ?>" title="" alt="">
                     </div>
                     <div class="col-md-6 employee">
                         <img src="<?php echo site_url('themes/images/hp.png'); ?>" title="" alt=""> 
                     </div>
                     <div class="col-md-6 employee">
                         <img src="<?php echo site_url('themes/images/ub.png'); ?>" title="" alt="">
                     </div>
                     <div class="col-md-6 employee">
                         <img src="<?php echo site_url('themes/images/stiva.png'); ?>" title="" alt=""> 
                     </div>
                     <div class="col-md-6 employee">
                         <img src="<?php echo site_url('themes/images/microsoft.png'); ?>" title="" alt="">
                     </div>
