        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <form name="form" class="" action="<?php echo site_url('dashboard/saveNewService'); ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body">
                       
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="text" name="btitle" class="form-control col-lg-9 " value="<?php echo set_value('btitle'); ?>" placeholder="Enter Service Title">
