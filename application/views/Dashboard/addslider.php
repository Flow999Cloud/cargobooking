        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <form name="form" class="" action="<?php echo site_url('dashboard/saveNewSlider'); ?>" method="post" enctype="multipart/form-data">
                    <div class="box-body"> 
                        <div class="row">
                            <p style="color: red;"><?php echo $this->session->userdata('msg'); ?></p>
                            <div class="col-md-4">
